...
;margin-bottom: 1em'><img  title='".$post->post_title."' src='" .  $first_img . "' style='left: -50px;position: absolute;top: -300px;' /></div>";
  } else {
...
function get_excerpt($count){
  ...
  $excerpt = substr($excerpt, 0, strpos($excerpt, ' ', $count));
  $excerpt .= "...";
  return $excerpt;
}
